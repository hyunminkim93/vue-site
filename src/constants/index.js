...
export const skillText = [
  {
    title: '신입 개발자의 꿈: 무한한 가능성의 시작',
    description:
      '신입 개발자에게 있어 꿈은 단순한 목표가 아니라 무한한 가능성의 시작입니다. 기술의 세계는 빠르게 변화하며, 매일 새로운 도전과 기회가 기다리고 있습니다. 처음에는 작은 코드 한 줄이었을지라도, 이 작은 코드가 모여 혁신적인 소프트웨어를 만들고, 세상을 변화시킬 수 있는 도구가 됩니다. 꿈을 가지고 있는 신입 개발자는 이러한 가능성을 두려워하지 않고, 끊임없이 배우고 성장하며, 자신의 한계를 뛰어넘을 준비가 되어 있습니다. 그들의 꿈은 곧 미래의 기술 혁신을 이끄는 원동력이 될 것입니다.'
  },
  {
    title: '신입 개발자의 의지: 끈기와 도전의 연속',
    description:
      '신입 개발자의 여정은 끊임없는 도전과 역경의 연속입니다. 새로운 기술을 배우고, 복잡한 문제를 해결하며, 종종 예상치 못한 오류와 마주하게 됩니다. 이러한 과정에서 중요한 것은 바로 포기하지 않는 의지입니다. 끈기와 도전 정신을 가지고 끊임없이 노력하는 신입 개발자는 결국 자신의 능력을 입증하고, 더 나은 개발자로 성장할 수 있습니다. 이들의 의지는 단순히 개인의 성공을 넘어, 팀과 조직의 성공을 함께 이끌어가는 중요한 원동력이 됩니다.'
  },
  {
    title: '신입 개발자의 열정: 혁신과 창의성의 원천',
    description:
      '열정은 신입 개발자가 가진 가장 큰 무기 중 하나입니다. 새로운 기술에 대한 호기심, 더 나은 코드를 작성하고자 하는 열망, 그리고 사용자에게 최고의 경험을 제공하고자 하는 마음가짐은 이들을 더욱 창의적이고 혁신적으로 만듭니다. 열정적인 신입 개발자는 기존의 틀을 깨고, 새로운 아이디어를 실현시키며, 기술의 경계를 넓혀 나갑니다. 이들의 열정은 조직의 문화와 분위기를 긍정적으로 변화시키고, 더 나은 세상을 만들어가는 데 큰 기여를 합니다.'
  }
]
